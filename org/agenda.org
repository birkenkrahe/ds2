...
* IN PROGRESS Week 7 - ~apply~, ~break~, ~next~, ~repeat~
#+attr_html: :width 400px
...
- How many male and female passengers died on the Titanic? Answer the
  question using R's ~tapply~ function.
...
* DONE Bonus exercises coding loops (24-Feb)
#+attr_latex: :width 400px
