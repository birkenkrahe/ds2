...
* TODO Week 9 - ~function~ creation and arguments
#+attr_latex: :width 400px
[[../img/function.jpg]]

*REMINDERS* (check your Canvas calendar):
- Complete *test 4* by tonight 11:59 pm!
- Complete *DataCamp assignment* "Utilities" by Friday this week!
- Complete *bonus assignment* with ~break~, ~next~, ~repeat~ by next week!
- [[https://lyon.instructure.com/courses/1041/assignments/9014][Literature review (2nd sprint review) by end of next week]]!

*THIS WEEK*:
- Writing functions with/without arguments with ~function~
- Returning results with/without ~return~
...
https://github.com/birkenkrahe/snap
* TODO Week 10 - exception handling and timing
