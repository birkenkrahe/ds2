...
- [ ] Bonus exercises for extra credit
- [ ] Projects 2nd sprint review looming (March 10)
- [ ] How to reference and document coding support by AI

* TODO DataCamp lesson due today for full points
* TODO New Datacamp lessons open - get certified!
* NEW Bonus exercises coding loops (End-of-week)
#+attr_latex: :width 400px
#+Caption: Photo by Frugal Flyer on Unsplash.com
[[../img/bonus.jpg]]

Download the *raw* bonus exercise file [[https://github.com/birkenkrahe/ds2/tree/main/org][from GitHub]] and save it as
~5_loop_for_bonus.org~. When done, upload the file to Canvas.
