...
* Week 11 - The Future & Exception handling
#+attr_latex: :width 400px
#+caption: Photo by Dunk Hacking the bridge to your future (Flickr.com)
[[../img/debugging.jpg]]

- I evaluated & graded outstanding exercises (*please check*)
- The literature reviews were all impressive in their own way:
...
- Late submissions for test 4 *by 3/31* for partial credit
- Next *test* due March 31 (open for partial credit until April): we'll
  review some questions on Wednesday

* DONE Predictions On The Future of Data Science
#+attr_latex: :width 400px
...
* DONE TidyverseSceptic and RDesign
#+attr_latex: :width 400px
...
* TODO Exercise: text mining function

- load ~nb_clean.org~ and replace the sequence of ~tm_map~ function calls
  to create a clean document by one function.

* TODO What did you learn this week?

Mon:
- how to execute a "close reading" of an online article
- validation and researching basic questions
- extracting and testing hypotheses with examples
