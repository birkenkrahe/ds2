...
* IN PROGRESS Week 12 - text mining / cmdline / regex
#+attr_latex: :width 400px
...
* DONE About Artificial Idiocy (AI)
#+attr_latex: :width 400px
...
* TODO Command line data science
#+attr_latex: :width 400px
...
- We're going to do it anyway - this week: regular expressions
  (regexp) and a tour of the cvskit Python package
