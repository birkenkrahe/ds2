...
* TODO Week 14 - Introduction to csvkit
#+attr_latex: :width 400px
...
* TODO What about the last DataCamp lesson? (BONUS)
#+attr_latex: :width 400px
...
* TODO Import Jupyter Notebook from Emacs
#+attr_latex: :width 400px
[[../img/import.png]]

1) Download ~import.zip~ from GitHub (bit.ly/ipynb_import)
2) Open a NEW empty DataCamp workspace
3) Open ~Browse and Upload Files~ in the left sidebar
4) Click the ~+~ button at the top and choose ~Upload~
5) Open the ~csvkit.ipynb~ file (the lecture script)

Converted to Jupyter notebook with ~ox-ipynb~ in Emacs! ([[https://github.com/jkitchin/ox-ipynb][Link]])
