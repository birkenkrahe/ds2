...
* Week 7 - ~apply~, ~break~, ~next~, ~repeat~
#+attr_html: :width 400px
...
* TODO Week 8 - writing functions ~return~
#+attr_latex: :width 400px
[[../img/function.jpg]]

** R data analysis without programming: ~lessR~
#+attr_latex: :width 200px
[[../img/lessR.png]]
...
- [ ] Let's write an example together!
  ...
  /Tip:/ ~strsplit(s,"")~ splits a string into its elements.

  #+begin_src R
    msg <- "weekend"
    result <- rep(NA,nchar(msg))
    result
    unlist(strsplit(order(msg,decreasing=TRUE),"")) -> msg
    msg
  ...
  : Error in strsplit(order(msg, decreasing = TRUE), "") :
  :   non-character argument
  : [1] "weekend"
  : [1] "weekend" NA        NA        NA        NA        NA        NA
  : [8] NA


* TODO Week 9 - function arguments, recursion
* TODO Week 10 - exceptions, timing, masking
* TODO Week 11 - utility functions, date, time
* TODO Week 12 - ~data.table~ for fast big data manipulation
* TODO Week 13 - command line data science
* TODO Week 14 - text mining
* TODO Week 15 - machine learning
