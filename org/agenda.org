...
* NEXT Week 11 - Exception handling
#+attr_latex: :width 400px
...
- Late submissions *by 3/31* for partial credit
- Next sprint review: results! *Due on April 21.*
- Next *test* due March 31.

* TODO Predictions On The Future of Data Science
#+attr_latex: :width 400px
...
* TODO TidyverseSceptic and RDesign

- [[https://github.com/matloff/TidyverseSkeptic/blob/master/RDesign.pdf][R Design Patterns, Base-R vs. Tidyverse]]
...
Fabio Moioli (Oct 13, 2022). Predictions on the Future of Data
